<form class="js-crud-form" data-store-url="{{ route('admin.customers.store') }}"
    data-show-url-base="{{ url('/admin/customers') }}" data-update-url-base="{{ url('/admin/customers') }}"
    data-destroy-url-base="{{ url('/admin/customers') }}" data-view-url-base="{{ url('/admin/customers') }}">
    @csrf
    ...
    <div class="form-fields">
        ...
        <x-admin.customers.tabs :author="$author ?? ''" />
