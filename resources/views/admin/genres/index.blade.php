<x-app-layout title="Géneros | Admin">
    ...
    @push('scripts')
        ...
        <script>
            document.addEventListener('DOMContentLoaded', () => {
                ...
                const form = document.querySelector('.js-genre-form');
                ...
                form.addEventListener('submit', async (e) => {
                    ...
                    const isUpdate = !!id;
                    /*
                     * Si es update, url = admin/genres/{id}  (PUT)
                     * Si es create, url = admin/genres      (POST)
                     */
                    const urlBase = form.dataset.showUrlBase; // .../admin/genres
                ...
                listContainer.addEventListener('click', async (e) => {
                    ...
                    // GET /admin/genres/{id} -> devuelve JSON
                    try {
